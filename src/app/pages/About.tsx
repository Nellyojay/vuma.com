      ...
      <section className="py-20 md:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-blue-500/20 to-purple-600/20 rounded-2xl p-8 md:p-12 border border-white/10 mb-16"
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-6">Our Story</h2>
            <div className="space-y-4 text-gray-300 leading-relaxed">
              <p>
                Vuma was born from a simple idea: social media should bring people together,
              ...
              <p>
                We built Vuma to be a platform where authenticity matters, where privacy is respected,
                ...
                new, Vuma is designed to make those experiences better.
              </p>
              <p>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            transition={{ duration: 0.7 }}
            viewport={{ once: true }}
            className="bg-gradient-to-br from-purple-500/20 to-pink-600/20 rounded-2xl p-8 md:p-12 border border-white/10 text-center"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-300 leading-relaxed">
                No more unwanted messages. Connect only with people who mutually want to talk.
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/10"
            >
              <h3 className="text-xl font-bold mb-4 text-purple-400">Anonymous Confessions</h3>
              <p className="text-gray-300 leading-relaxed">
